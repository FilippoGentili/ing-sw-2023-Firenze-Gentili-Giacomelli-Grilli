...
class CommonGoalCard10Test {
    ...
    void CreatingOneX(){
        ...
        Tile cat2 = new Tile(TileType.CAT, Location.BOOKSHELF);
        ArrayList<Tile> TileCat2 = new ArrayList<>();
        TileCat2.add(cat2);

        Tile cat3 = new Tile(TileType.CAT, Location.BOOKSHELF);
        ArrayList<Tile> TileCat3 = new ArrayList<>();
        TileCat3.add(cat3);

        Tile cat4 = new Tile(TileType.CAT, Location.BOOKSHELF);
        ...
        Tile book2 = new Tile(TileType.BOOK, Location.BOOKSHELF);
